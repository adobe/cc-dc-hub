...
export const SearchPage = () => {
  ...
  return (
    <View id="search-section">
       ...
       ********************************************************************/}
      <Banner>
        Please remember, the tools on this site are <b>not</b> supported by
        Adobe. Log issues to their respective projects, which you can find on
        their tool detail page.
      </Banner>
      <View id="container">
        <Content id="content">
